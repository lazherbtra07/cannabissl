...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    profileImage: "/milena.png", // You'll need to add this image
  ...
  return (
    <section className="py-20 px-6 bg-black">
      <div className="max-w-[95%] mx-auto">
        {/* Main Heading */}
        <h2 className="text-5xl md:text-6xl font-bold text-white text-center mb-16 font-orbitron tracking-wide">
          How you felt...
        </h2>
        ...
        <div className="text-center">
          <p className="text-gray-400 text-lg mb-6 font-orbitron">
            Have you tried it already?
          </p>
          <button className="px-8 py-3 border border-white text-white rounded-full hover:bg-white hover:text-black transition-colors font-medium font-orbitron">
            Add your feeling
          </button>
        </div>
      </div>
